...
class Extensions extends \CMax{
    public static $swiperJsPath = '';
    
    public static function register(){
        $fullUri = $_SERVER['REQUEST_URI'];
        $swiperJsPath = '';
        if (strpos($fullUri, 'ulichnie-lesntitsy') !== false) {
            $swiperJsPath = 'none_swiper';
        } else {
            $swiperJsPath = SITE_TEMPLATE_PATH.'/vendor/js/carousel/swiper/swiper-bundle.min.js';
        }
		$arConfig = [
			'animation_ext' => [
